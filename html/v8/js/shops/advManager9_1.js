    ...
    inheritableStatics : {
    		init:function(){
						for(j=1; j<store_shops_advmanager.getCount()+1; j++){
			  	      		...
			  	      		case "16":	Ext.getCmp('advmanager_ads16').setSrc(store_shops_advmanager.getAt(j-1).get('imgpath')); break;
			  	      		case "17":	Ext.getCmp('advmanager_ads17').setSrc(store_shops_advmanager.getAt(j-1).get('imgpath')); break;
			  	      		case "18":	Ext.getCmp('advmanager_ads18').setSrc(store_shops_advmanager.getAt(j-1).get('imgpath')); break;
			  	      		case "19":	Ext.getCmp('advmanager_ads19').setSrc(store_shops_advmanager.getAt(j-1).get('imgpath')); break;
			  	      		case "20":	Ext.getCmp('advmanager_ads20').setSrc(store_shops_advmanager.getAt(j-1).get('imgpath')); break;
			  	      		case "21":	Ext.getCmp('advmanager_ads21').setSrc(store_shops_advmanager.getAt(j-1).get('imgpath')); break;
			  	      		default:break;
			  	      }	
						}
    		}
