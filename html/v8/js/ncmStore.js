...
Ext.define('ncViewer.ncmStore',{
    extend: 'Ext.tab.Panel',

    initComponent : function(){
    	  ncViewer.ncmStore.compid = "";
        ncViewer.ncmStore.compname = "";
 ...
 //       activeTab: 0,        
        ...
        items: [{
            title: '聊天内容', 
            id:'imcontent',           
            html: '<iframe  id="lay_rzck_imcontent" name="lay_rzck_imcontent" src="/v8/ncmdept/ncm_webshowuseronline.htm" scrolling="no" width=100% height=950  FrameBorder=0 ></iframe>' 
        },
        {
            title: '屏幕日志',
            id:'screenlog',            
