...
//alert(self.location.href);
	...
	{
      document.getElementById("iframe1").src = "/pronline/Msg?FunName@ncmWebReplace&plate@newshopyuyuan/shop_menus2.htm&tsid@"+tsid;
  }

}
function f(tsid){
    document.getElementById("iframe1").src = "/pronline/Msg?FunName@ncmWebReplace&plate@zhengzhoudianxin/shop_menus2.htm&tsid@"+tsid;
    document.getElementById("logo").innerHTML = "豫园";
}
