						...
						items:[{
					  		...
					  		handler:function(){
					  			  ...
					  			  if(window.navigator.userAgent.indexOf("MSIE")>=1){
					  			  	  ...
					  			  	  if(Ext.getCmp('advmanager3_level').value == 10){
					  			  	  		gotoedit3(Ext.getCmp('advmanager3_img_long').value, Ext.getCmp('advmanager3_img_width').value);
					  			  	  }else{
		        	  ...
		        	  layout: 'vbox',
			       		...
			       		items:[{
			       			...
			       			items:[{
				       				...
				       				height:80,
				       				id:"advmanager3_ads5"
				       				//src:'/images/yuyuan3/yuyuan3-04_r4_c1.jpg'	
			       			}]
			       		},{
			       			layout: 'hbox',
			       			width:400,
			       			...
			       			items:[{
				       				...
				       				width:400,
				       				height:20,
				       				src:'/images/yuyuannew/yuyuan3-04_r5_c1.jpg'	
			       			}]
			       		},{
			       			layout: 'hbox',
			       			width:400,
			       			...
			       			items:[{
				       			...
				       			items:[{
					       				...
					       				width:400,
					       				height:40,
					       				src:'/images/yuyuannew/yuyuan3-04_r8_c1.jpg'	
				       			}]	
			       		},{
			       			layout: 'hbox',
			       			width:400,
