function a(murl,mtitle,tsid){
    self.location.href = murl+"/pronline/Msg?FunName@ncmWebReplace&plate@zhengzhoudianxin/shop_menus2.htm&tsid@"+tsid;
...
//     alert(rurl);
	...
	{  
             ...
             self.location.href = rurl;
              ...
              var stateObject = {};
              history.pushState(stateObject,"tttt","?pro@d");
              parent.self.location.href = rurl;
        }
}
...
{  
    ...
    {//alert(2);
    	if(port != '')
	      	self.location.href = "http://"+ip+":"+port+"/pronline/Msg?FunName@ncSrvPlate&lang@"+""+"&code@"+""+"&usernametmp@"+""+"&html@"+"/logout_ok.htm&"+rurl;
	    else
	      	self.location.href = "http://"+ip+"/pronline/Msg?FunName@ncSrvPlate&lang@"+""+"&code@"+""+"&usernametmp@"+""+"&html@"+"/logout_ok.htm&"+rurl;
    ...
    else
    {
	    if (astatus == 1)
	    {
//	    	var aaaa="http://"+ip+":"+port+"/pronline/Msg?FunName@ncSrvPlate&lang@"+""+"&code@"+""+"&usernametmp@"+""+"&html@"+"alogin_main.htm&"+rurl;
//	    	alert(aaaa);
	    	if(port != ''){
	      	self.location.href = "http://"+ip+":"+port+"/pronline/Msg?FunName@ncSrvPlate&lang@"+""+"&code@"+""+"&usernametmp@"+""+"&html@"+"alogin_main.htm&"+rurl;
	      }
	    	else{
	    			self.location = "http://"+ip+"/pronline/Msg?FunName@ncSrvPlate&lang@"+""+"&code@"+""+"&usernametmp@"+""+"&html@"+"alogin_main.htm&"+rurl;
//	      	self.location.href = "http://"+ip+"/pronline/Msg?FunName@ncSrvPlate&lang@"+""+"&code@"+""+"&usernametmp@"+""+"&html@"+"alogin_main.htm&"+rurl;
	      }
	    }
	    else if (astatus == 2)
	    {
		    if(port != '')
		      self.location.href = "http://"+ip+":"+port+"/pronline/Msg?FunName@ncSrvPlate&lang@"+""+"&code@"+""+"&usernametmp@"+""+"&html@"+"/alogin_main_auto.htm&"+rurl;
		    else
		      self.location.href = "http://"+ip+"/pronline/Msg?FunName@ncSrvPlate&lang@"+""+"&code@"+""+"&usernametmp@"+""+"&html@"+"/alogin_main_auto.htm&"+rurl;
      }else{}
...
//function k('[#posturl#]')
//{
//	self.location.href = "http://192.168.21.192:9080/pronline/Msg?FunName@ncSrvPlate&html@"+"/alogin_main.htm&"+'[#getarg#]';
//}

function e (ip,port,getarg,tsid,statusCode)
{//  alert(tsid);
//alert(221);alert(document.getElementById("rg").value);alert(223);
    // alert(parent.self.location.href);
...
//	else 
//	{
//      self.location.href = "/pronline/Msg?FunName@ncmWebReplace&plate@zhengzhoudianxin/shop_menus2.htm&tsid@"+tsid;
//  }

}
function f(tsid,getarg){
document.getElementById("FunName_t").value = "ncm_yuyuan_home";
document.getElementById("form_t").getarg.value = getarg;
document.getElementById("form_t").submit();
//    self.location.href = "/pronline/Msg?FunName@ncm_yuyuan_home&tsid@"+tsid+'&getarg@'+'"'+encodeURIComponent(getarg)+'"';

    document.getElementById("logo").innerHTML = "丹尼斯欢迎你";
}
...
//alert("up = "+up);
    ...
    else
    {
	    ...
	    {
		    if(port != '')
		      self.location.href = "http://"+ip+":"+port+"/pronline/Msg?FunName@ncSrvPlate&lang@"+""+"&code@"+""+"&usernametmp@"+""+"&html@"+"/alogin_main_auto.htm&"+rurl+"&up@"+up;
		    else
		      self.location.href = "http://"+ip+"/pronline/Msg?FunName@ncSrvPlate&lang@"+""+"&code@"+""+"&usernametmp@"+""+"&html@"+"/alogin_main_auto.htm&"+rurl+"&up@"+up;
      }else{}
      document.getElementById("logo").innerHTML = "我要上网"; 
    }
...
//	   alert(scode);
    ...
    if (scode == 0)
    {
	    self.location.href = httphost+"/pronline/Msg?FunName@ncSrvLogOut&html@"+"/logout_ok.htm";
//	    alert(self.location.href);
	    document.getElementById("logo").innerHTML = "开始上网"; 
    ...
    {var rurl;
	    if (astatus == 1)
	    {
	        self.location.href = httphost+"/pronline/Msg?FunName@ncSrvPlate&html@"+"/alogin_main.htm&"+rurl;
	    }
	    else if (astatus == 2)
	    {
		      self.location.href = httphost+"/pronline/Msg?FunName@ncSrvPlate&html@"+"/alogin_main_auto.htm&"+rurl;
      }else{}
      document.getElementById("logo").innerHTML = "我要上网"; 
    }
...
var backnumber = 0;
backURL[backnumber] = "/pronline/Msg?FunName@ncm_yuyuan_home&plateName@newshop";
function back(tsid){
//alert(tsid);
...
if (searchflag == 0){
	...
	document.getElementById('searchIcon').src = "/images/suning/delete1.png"
	searchflag = 1;
}else{
	document.getElementById('searchdiv').style.display="none";
	document.getElementById('searchIcon').src = "/images/search.png"
	searchflag = 0;
}
}
function searchShop(){
// document.getElementById("iframe1").contentWindow.document.getElementById("FunName").value = "ncmCategories";
// document.getElementById("iframe1").contentWindow.document.getElementById("form1").submit();
//document.getElementById('iframe1').contentWindow.document.getElementById("FunName").value="ncm_ShopType";

//document.getElementById('iframe1').contentWindow.document.getElementById('keyword').value=document.getElementById("keywords").value;
...
//document.getElementById('iframe1').contentWindow.document.getElementById('form1').submit();
 ...
 self.location.href="/pronline/Msg?FunName@ncm_ShopType&plateName@newshop&&tsid@"+document.getElementById('iframe1').contentWindow.document.getElementById("tsid").value+"&plateid@"+document.getElementById('iframe1').contentWindow.document.getElementById("plateid").value+"&keyword@"+document.getElementById("keywords").value;

//parent.addURL("/pronline/Msg?FunName@ncmShops&plateName@zhengzhoudianxin&shopid@"+shopids[number]+"&tsid@"+document.getElementById("tsid").value+"&plateid@"+document.getElementById("plateid").value);
}
