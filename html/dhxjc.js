function a(murl,mtitle,tsid){
    document.getElementById("iframe1").src = murl+"/pronline/Msg?FunName@ncmWebReplace&plate@newshopdh/shop_menus2.htm&tsid@"+tsid;
...
//alert(self.location.href);
	...
	{
      document.getElementById("iframe1").src = "/pronline/Msg?FunName@ncmWebReplace&plate@newshopdh/shop_menus2.htm&tsid@"+tsid;
  }

}
function f(tsid){
    document.getElementById("iframe1").src = "/pronline/Msg?FunName@ncmWebReplace&plate@newshopdh/shop_menus2.htm&tsid@"+tsid;
    document.getElementById("logo").innerHTML = "德化新街";
}
...
//parent.addURL("/pronline/Msg?FunName@ncmShops&plateName@newshopdh&shopid@"+shopids[number]+"&tsid@"+document.getElementById("tsid").value+"&plateid@"+document.getElementById("plateid").value);
}
