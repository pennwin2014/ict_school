...
/*
		...
		*/
			...
			Ext.getCmp("layout_center").add({autoScroll:true,id:'charts_devicebrand',iconCls: 'chart_pie',border:false,frame:false,title: "终端品牌", items:[Ext.create('charts.deviceBrand')]});
			...
			Ext.getCmp("layout_center").add({autoScroll:true,id:'charts_deviceType',iconCls: 'chart_pie',border:false,frame:false,title: "终端类型", items:[Ext.create('charts.deviceType')]});
...
//											if(store_shops_shopGwdh.alreadyadd != 1)
//											Ext.getCmp('shops_gwdh').add(Ext.create('shops.shopGwdh'));
//									        Ext.getCmp('page_main').bind(store_shops_shopGwdh);
//											store_shops_shopGwdh.new_params={plateid:plateid};
//											Ext.getCmp('page_main').doRefresh();
											Ext.getCmp('page_main').setVisible(false);
//											store_shops_shopGwdh.alreadyadd = 1;
									            	}
...
*/
											...
											if(store_shops_mallmanager.alreadyadd != 1)
											Ext.getCmp('shops_mallmanager').add(Ext.create('shops.mallManager'));
											Ext.getCmp('page_main').bind(store_shops_mallmanager);
											Ext.getCmp('page_main').setVisible(true);
											Ext.getCmp('page_main').doRefresh();
											store_shops_mallmanager.alreadyadd = 1;
									  }
//										else if(p.title=='单位组管理'){
...
//									  } 	
//									   else if(p.title=='组织架构权限'){
//											 if(store_systems_autopri.alreadyadd != 1)
//											 Ext.getCmp('systems_autopri').add(Ext.create('systems.autopri'));
//											 Ext.getCmp('page_main').bind(store_systems_autopri);
//											 Ext.getCmp('page_main').setVisible(true);
//											 Ext.getCmp('page_main').doRefresh();
//											 store_systems_autopri.alreadyadd = 1;
//									   } 									  
	      ...
	      if(tab_len>=1){
	      	for(i=0;i<tab_len;i++){     		
				...
				if(tab_id=='ssjk'){
					  ...
					  store_online_onlinemac.alreadyadd=0; 
						...
						if(right_sfun.indexOf("在线信息")>=0){
							  ...
							  //tabs_center.getComponent('online_onlineinfo').destroy();
								tabs_center.add({autoScroll:true,id:tab_id+'_onlineinfo',iconCls: 'onlineinfo',border:false,frame:false,title: "在线信息"});  
						}
				    ...
				    if(right_sfun.indexOf("在线Mac")>0)tabs_center.add({autoScroll:true,id:tab_id+'_onlinemac',iconCls: 'onlineinfo',border:false,frame:false,title: "在线Mac"});
				}	
...
//						tabs_center.add({autoScroll:true,id:tab_id+'_usermanager',iconCls: 'user',border:false,frame:false,title: "员工管理"});
						if(admincheck == "admin" || isexp == 'false')tabs_center.add({autoScroll:true,id:tab_id+'_staffmanager',iconCls: 'user',border:false,frame:false,title: "用户管理"});
					  //tabs_center.add({autoScroll:true,id:tab_id+'_usermacmanager',iconCls: 'user',border:false,frame:false,title: "用户MAC管理"});
					  if(right_sfun.indexOf("单位管理")>0)tabs_center.add({autoScroll:true,id:'users_groupmanager',iconCls: 'user',border:false,frame:false,title: "单位管理"});
...
//					  });
					  ...
					  tabs_center.add({autoScroll:true,id:tab_id+'_swrs',iconCls: 'report',border:false,frame:false,title: "上网人数统计",
					  ...
					  tabs_center.add({autoScroll:true,id:tab_id+'_sort',iconCls: 'report',border:false,frame:false,title: "用户上网天数排行",
			 	    ...
			 	    if(right_sfun.indexOf("短信发送报表")>0)tabs_center.add({autoScroll:true,id:tab_id+'_smsreport',iconCls: 'report',border:false,frame:false,title: "短信发送报表"});
					  if(right_sfun.indexOf("短信发送详情")>0)tabs_center.add({autoScroll:true,id:tab_id+'_smsdetailreport',iconCls: 'report',border:false,frame:false,title: "短信发送详情"});
		//		    if(right_sfun.indexOf("上网人数流量报表")>0)tabs_center.add({autoScroll:true,id:tab_id+'_webreport',iconCls: 'report',border:false,frame:false,title: "上网人数流量报表"});
						if(right_sfun.indexOf("上网详情")>0)tabs_center.add({autoScroll:true,id:tab_id+'_webdetailreport',iconCls: 'report',border:false,frame:false,title: "上网详情"});
						if(right_sfun.indexOf("设备类型统计")>0)tabs_center.add({autoScroll:true,id:tab_id+'_devicereport',iconCls: 'report',border:false,frame:false,title: "设备类型统计"});   
...
//						if(right_sfun.indexOf("用户流量报表")>0)tabs_center.add({autoScroll:true,id:tab_id+'_trafficreport',iconCls: 'report',border:false,frame:false,title: "用户流量报表"}); 
						...
						if(right_sfun.indexOf("AP终端数量")>0)tabs_center.add({autoScroll:true,id:tab_id+'_macreport',iconCls: 'report',border:false,frame:false,title: "AP终端数量"});   
						/*  为了香港广场注释*/
					 ...
					 if(right_sfun.indexOf("到店频次统计")>0){
							tabs_center.add({autoScroll:true,id:tab_id+'_frequencyreport',iconCls: 'report',border:false,frame:false,title: "到店频次统计",html: '<iframe  id="charts_smsrecount1" name="charts_smsrecount" src="/ncm_chart/frequencyreport.html" scrolling="no" width=100% height=1200  FrameBorder=0 ></iframe>' });
						}
					if(right_sfun.indexOf("到店规律统计")>0){
						tabs_center.add({autoScroll:true,id:tab_id+'_rulereport',iconCls: 'report',border:false,frame:false,title: "到店规律统计",html: '<iframe  id="charts_rule" name="charts_smsrule" src="/ncm_chart/rule_report.html" scrolling="no" width=100% height=950  FrameBorder=0 ></iframe>' }); 
					}   
					 if(right_sfun.indexOf("固定顾客分析")>0){ 
						tabs_center.add({autoScroll:true,id:tab_id+'_customeranalyze',iconCls: 'report',border:false,frame:false,title: "固定顾客分析",html: '<iframe  id="charts_customeranalyze" name="charts_customeranalyze" src="/ncm_chart/customer_analyze.html" scrolling="no" width=100% height=950  FrameBorder=0 ></iframe>' });
					}
...
//						tabs_center.add({autoScroll:true,id:tab_id+'_website_visit_type',iconCls: 'report',border:false,frame:false,title: "访问网站类型",html: '<iframe  id="website_visit_type" name="website_visit_type" src="/ncm_chart/website_visit_type.html" scrolling="no" width=100% height=950  FrameBorder=0 ></iframe>' });
						...
						if(right_sfun.indexOf("广告页面管理")>0)tabs_center.add({autoScroll:true,id:tab_id+'_advmanager',iconCls: 'shops_ad',border:false,frame:false,title: "广告页面管理"});
...
//				    	 html: '<iframe id="lay_ok_manger" name="lay_ok_manger" src="/ncmshop/ncm_okmanager.htm" scrolling="no" width=100% height=950  FrameBorder=0 ></iframe>' });
            ...
            tabs_center.add({autoScroll:true,id:tab_id+'_gwdh',iconCls: 'shops_ad',border:false,frame:false,title: "购物导航",
            ...
            tabs_center.add({autoScroll:true,id:tab_id+'_cxyh',iconCls: 'shops_ad',border:false,frame:false,title: "促销优惠",
						...
						if(right_sfun.indexOf("商店管理")>0)tabs_center.add({autoScroll:true,id:tab_id+'_shopmanager',iconCls: 'shops_shop',border:false,frame:false,title: "商店管理"});	
...
//						if(right_sfun.indexOf("品牌管理")>0)tabs_center.add({autoScroll:true,id:tab_id+'_brandmanager',iconCls: 'star',border:false,frame:false,title: "品牌管理"});
						if(right_sfun.indexOf("商品管理")>0)tabs_center.add({autoScroll:true,id:tab_id+'_oditymanager',iconCls: 'shops_product',border:false,frame:false,title: "商品管理"});
						if(right_sfun.indexOf("商标类别管理")>0)tabs_center.add({autoScroll:true,id:tab_id+'_categorymanager',iconCls: 'shops_type',border:false,frame:false,title: "商标类别管理"});
						if(right_sfun.indexOf("会员管理")>0)tabs_center.add({autoScroll:true,id:tab_id+'_usermanager',iconCls: 'shops_vip',border:false,frame:false,title: "会员管理"});
...
//						if(right_sfun.indexOf("晋级管理")>0)tabs_center.add({autoScroll:true,id:tab_id+'_compmanager',iconCls: 'shops_comp',border:false,frame:false,title: "晋级管理"});
						...
						if(right_sfun.indexOf("短信管理")>0)tabs_center.add({autoScroll:true,id:'shops_smsmanager',iconCls: 'phone',border:false,frame:false,title: "短信管理"});
...
//						if(right_sfun.indexOf("商家联盟管理")>0)tabs_center.add({autoScroll:true,id:'shops_shoptypemanager',iconCls: 'shoptype',border:false,frame:false,title: "商家联盟管理"});
						if(right_sfun.indexOf("楼层管理")>0)tabs_center.add({autoScroll:true,id:'shops_mallmanager',iconCls: 'shoptype',border:false,frame:false,title: "楼层管理"});
						createPlateTab();//创建模板
				} 
						...
						store_charts_groupsms.alreadyadd=0;
					 	if(right_sfun.indexOf("终端品牌")>0)tabs_center.add({autoScroll:true,id:'charts_devicebrand',iconCls:'chart_pie',border:false,frame:false,title: "终端品牌"});
						if(right_sfun.indexOf("终端类型")>0)tabs_center.add({autoScroll:true,id:'charts_devicetype',iconCls:'chart_pie',border:false,frame:false,title: "终端类型"});	
						...
						if(right_sfun.indexOf("终端操作系统")>0)tabs_center.add({autoScroll:true,id:'charts_deviceos',iconCls:'chart_pie',border:false,frame:false,title: "终端操作系统"});	
		...
		*/
						...
						if(right_sfun.indexOf("短信日志")>0)tabs_center.add({autoScroll:true,id:tab_id+'_smslog',iconCls: 'log',border:false,frame:false,title: "短信日志"});
						if(right_sfun.indexOf("用户日志")>0)tabs_center.add({autoScroll:true,id:tab_id+'_userlog',iconCls: 'log',border:false,frame:false,title: "用户日志"});
						// tabs_center.add({autoScroll:true,id:tab_id+'_adlog',iconCls: 'log',border:false,frame:false,title: "广告日志"}); 
						if(right_sfun.indexOf("告警日志")>0)tabs_center.add({autoScroll:true,id:tab_id+'_alarmlog',iconCls: 'log',border:false,frame:false,title: "告警日志"}); 
						if(right_sfun.indexOf("MAC日志")>0)tabs_center.add({autoScroll:true,id:tab_id+'_maclog',iconCls: 'log',border:false,frame:false,title: "MAC日志"}); 
						createAreaTab();
				} 
						...
						if(right_sfun.indexOf("黑名单")>0)tabs_center.add({autoScroll:true,id:tab_id+'_blackuser',iconCls: 'rule',border:false,frame:false,title: "黑名单"});
						
						if(right_sfun.indexOf("SSID管理")>0)tabs_center.add({autoScroll:true,id:'users_ssidmanager',iconCls: 'rule',border:false,frame:false,title: "SSID管理"});
						if(right_sfun.indexOf("模板管理")>0)tabs_center.add({autoScroll:true,id:tab_id+'_plate',iconCls: 'rule',border:false,frame:false,title: "模板管理"});
