...
//短信日志
var store_logs_smslog = Ext.create('Ext.data.Store', {pageSize: 25,id:'store_logs_smslog',fields: ['sid', 'servicecode', 'did', 'dname', 'gid', 'gname', 'userid', 'username', 'usermac', 'ip', 'logtime', 'smsname', 'sptype', 'areacode', 'areaname', 'contrycode', 'status'],remoteSort: true,autoLoad: false,
...
//短信详情
var store_reports_smsdetailreport = Ext.create('Ext.data.Store', {pageSize: 25,id:'store_reports_smsdetailreport',fields: ['contrycode', 'username', 'usermac', 'ip', 'logtime', 'sptype', 'areaname'],remoteSort: true,autoLoad: false,
...
var store_reports_trafficreport = Ext.create('Ext.data.Store', {pageSize: 25,id:'store_reports_trafficreport',fields: ['username', 'ssid', 'traffic'],remoteSort: true,autoLoad: false,
			      proxy: {type: 'ajax',url: '/pronline/Msg?FunName@ncm_web_App_intTrafficReport_list',reader: {type:'json',root: 'eimdata',totalProperty: 'totalCount'},simpleSortMode: true
			      },sorters: []});
...
var store_charts_deviceos = Ext.create('Ext.data.Store', {pageSize: 10,id:'store_charts_deviceos',fields: [ {name:'chart_name',type:'string'}, 'inum', {name:'chart_number',type:'int'}, {name:'rate',type:'string'}
			      ...
			      proxy: {type: 'ajax',url: '/pronline/Msg?FunName@ncm_web_MC_os_chart',reader: {type:'json',root: 'eimdata',totalProperty: 'totalCount'},simpleSortMode: true
			      },sorters: []});
...
/*在线信息*/
//在线信息   
var store_online_onlineinfo = Ext.create('Ext.data.Store', {pageSize: 25,id:'store_online_onlineinfo',fields: ['on_name', 'on_dispname', 'on_pass', 'on_ssid','on_apname','on_temtype','on_os','on_lang','on_login','on_byte','on_sdate','on_lasttime'],remoteSort: true,autoLoad: false,
...
//黑名单设置	
var store_rules_blackuser = Ext.create('Ext.data.Store',{pageSize: 25,fields: ['utype', 'name', 'memo', 'validtime', 'systime'],autoLoad: false,id:'store_rules_blackuser',remoteSort: true,
...
//参数设置	
var store_rules_srvpar = Ext.create('Ext.data.Store',{pageSize: 20,fields: ['pid','ptype','sessiontime','idletime','macbindtime','smslocalnum','smsinternum','smsusetime','limittime','limitunit','passcodetime','servicetime','eng_smsmessage','zh_smsmessage','autoauth','macauth','weixinauth','maxmac','errornum','errorlock','addtime','moditime','paroption','flags'],autoLoad: false,id:'store_rules_srvpar',remoteSort: true,
...
//模板管理	
var store_rules_plate = Ext.create('Ext.data.Store',{pageSize: 25,fields: ['plateid', 'platename', 'addtime', 'moditime'],autoLoad: false,id:'store_rules_plate',remoteSort: true,
...
/*用户管理*/
//员工管理	
var store_users_usermanager = Ext.create('Ext.data.Store',{pageSize: 20,fields: ['iNum', 'userid', 'username', 'dispname', 'groupname', 'groupid', 'ssid', 'proname', 'openid', 'usermac', 'macnum', 'password', 'mark', 'addtime', 'moditime', 'lasttime', 'expiretime', 'usertype', 'flags'],autoLoad: false,id:'store_users_usermanager',remoteSort: true,
...
//用户管理	
var store_users_staffmanager = Ext.create('Ext.data.Store',{pageSize: 25,fields: ['iNum', 'userid', 'username', 'dispname', 'groupname', 'groupid', 'ssid', 'proname', 'openid', 'usermac', 'macnum', 'password', 'mark', 'addtime', 'moditime', 'lasttime', 'expiretime', 'usertype', 'flags'],autoLoad: false,id:'store_users_staffmanager',remoteSort: true,
...
//用户MAC管理
var store_users_usermacmanager = Ext.create('Ext.data.Store',{pageSize: 25,fields: ['usermac', 'username', 'groupname', 'groupid', 'starttime', 'sdate', 'stime', 'lasttime', 'edate', 'etime', 'moditime', 'flags', 's_flags'],autoLoad: false,id:'store_users_usermacmanager',remoteSort: true,
...
//AP管理	
var store_users_apmanager = Ext.create('Ext.data.Store',{pageSize: 25,fields: ['groupid', 'gwid', 'longitude', 'latitude', 'addtime', 'flags', 's_flags'],autoLoad: false,id:'store_users_apmanager',remoteSort: true,
...
//SSID管理	
var store_users_ssidmanager = Ext.create('Ext.data.Store',{pageSize: 25,fields: ['sid', 'groupid', 'groupname', 'ssid', 'addtime', 'moditime', 'flags', 's_flags'],autoLoad: false,id:'store_users_ssidmanager',remoteSort: true,
...
function updatePage() {
   if (xmlHttp.readyState == 4) {
	    ...
	    var temp_level=getxmlbyname(response,"<level>","</level>");
