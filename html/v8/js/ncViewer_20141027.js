	  ...
	  Ext.getCmp('leftAll').setWidth(302);
        ...
        html: '<iframe  id="treetab_analysisTab" name="treetab_analysisTab" src="/v8/ncm_analysis_tree.htm" scrolling="no" width=100% height="'+bbb+'"  FrameBorder=0 ></iframe>'
			  ...
			  /*items:[{
			  	  ...
			  	  xtype:'button',
			  	  width:260,
			  		text:'<center>'+'数据报表'+'</center>',
			  		itemId:'sjbb',
			  		style:{margin:'20px'},	
			  		handler:this.onItemClick
			  		//html:'<ul><li>游览动线</li><li>游客实时分布</li><li>栏目点击率</li><li>客群分析</li></ul>'
			  },{
			  	  xtype:'button',
			  	  width:260,
			  		text:'<center>'+'Portal管理'+'</center>',
			  		itemId:'ptgl',
			  		style:{margin:'20px'},
			  		handler:this.onItemClick		
			  },{
		...
		tabframe=index.id;
			...
			if(plateid == ''){
				  ...
				  if(plateid == 1949796946){  // 豫园demo
					...
					}else if(plateid == 1398571206){  // 标准模板
					...
					}else if(plateid == 5 || plateid == 1225573834 || plateid == 1088452031){//如果是模板5，默认新商城模板
