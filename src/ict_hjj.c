...

{
...

  {
    ...
    snprintf(caMsg, sizeof(caMsg) - 1, "Ìí¼ÓÁôÑÔÊ§°Ü!");

    utPltPutVar(psDbHead, "mesg", convert("GBK", "UTF-8", caMsg));
	
	utPltPutVar(psDbHead, "success", "false");
    utPltPutVarF(psDbHead, "result", "%d", 2);//Ìí¼ÓÁôÑÔÊ§°Ü!
...

  {
    ...
    snprintf(caMsg, sizeof(caMsg) - 1, "Ìí¼ÓÁôÑÔ³É¹¦!");

    utPltPutVar(psDbHead, "mesg", convert("GBK", "UTF-8", caMsg));
	utPltPutVar(psDbHead, "success", "true");

    utPltPutVarF(psDbHead, "result", "%d", 0);//Ìí¼ÓÁôÑÔ³É¹¦
...

{
...

  {
    ...
    snprintf(caMsg, sizeof(caMsg) - 1, "Ì×²ÍĞŞ¸ÄÊ§°Ü!,sqlÓï¾äÖ´ĞĞ²»³É¹¦!");

    utPltPutVar(psDbHead, "mesg", convert("GBK", "UTF-8", caMsg));

    utPltPutVarF(psDbHead, "result", "%d", 2);//Ì×²ÍĞŞ¸ÄÊ§°Ü°
...

  {
    ...
    snprintf(caMsg, sizeof(caMsg) - 1, "Ì×²ÍĞŞ¸Ä³É¹¦!");

    utPltPutVar(psDbHead, "mesg", convert("GBK", "UTF-8", caMsg));

    utPltPutVarF(psDbHead, "result", "%d", 0);//Ì×²ÍĞŞ¸Ä³É¹¦
