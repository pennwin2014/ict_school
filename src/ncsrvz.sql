-- 2014/06/21 dsuser 增加 管理区域代码opt alter table dsuser add opt varchar(255) default '';
...
-- 区域类别商城权限表(no)
drop table if exists ncmshopgroup;
create table ncmshopgroup (
    groupid          int     primary key,
    groupname        char(32),                                -- 对象名称
    groupcode        char(32),                                -- 组编码
    curcode          char(32),                                -- 当前权限编码
    systime          int default 0,                           -- 操作系统时间
    pid              int default 0                            -- 上级组id
);

-- 区域类别商城权限表
drop table if exists ncmshopgroup;
create table ncmshopgroup (
    groupcode        char(32)   primary key,            -- 组编码
    groupname        char(32),                          -- 对象名称
    curcode          char(32),                          -- 当前权限编码
    systime          int default 0,                     -- 操作系统时间
    pid              char(32)                           -- 上级组id
...
-- 类别，商超管理表
drop table if exists ncmshopgtype;
create table ncmshopgtype (
    id          int     primary key,
    groupname        char(32),                                -- 类别/商超名称
    groupcode        char(32),                                -- 组编码
    systime          int default 0,                           -- 操作系统时间
    type             int default 0                            -- 类别 1 编码78位类别  2 编码910位商超编码
);
