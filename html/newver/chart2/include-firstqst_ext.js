...
//        theme = getQueryParam('theme') || 'neptune',
    ...
    if (includeCSS) {//alert(suffix);
//        document.write('<link rel="stylesheet" type="text/css" href="' + path + '/resources/css/ext-all' + suffix + '-debug.css"/>');
        document.write('<link rel="stylesheet" type="text/css" href="/newver/chart2/resources/css/ext-all-debug.css"/>');
    }
 //   alert(rtl);
//    document.write('<script type="text/javascript" src="' + path + '/ext-all' + (rtl ? '-rtl' : '') + '.js"></script>');
document.write('<script type="text/javascript" src="/newver/chart2/ext-all-rtl.js"></script>');
    if (neptune) {
