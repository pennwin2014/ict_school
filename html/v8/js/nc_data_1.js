...
//短信日志
var store_logs_smslog = Ext.create('Ext.data.Store', {pageSize: 25,id:'store_logs_smslog',fields: ['sid', 'servicecode', 'groupname', 'userid', 'username', 'usermac', 'ip', 'logtime', 'smsname', 'sptype', 'areacode', 'areaname', 'contrycode', 'status'],remoteSort: true,autoLoad: false,
...
//SSID统计报表
var store_reports_ssidreport = Ext.create('Ext.data.Store', {pageSize: 2,id:'store_reports_ssidreport',fields: ['ssid', 'num'],remoteSort: true,autoLoad: false,
...
/*在线信息*/
//在线信息   
var store_online_onlineinfo = Ext.create('Ext.data.Store', {pageSize: 25,id:'store_online_onlineinfo',fields: ['on_name', 'on_dispname', 'on_pass', 'on_ssid','on_apname','on_temtype','on_os','on_lang','on_login','on_byte','on_sdate','on_mac','on_caDev','on_ip','on_lasttime'],remoteSort:true,autoLoad:false,
